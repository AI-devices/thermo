abstract class Lang { //TODO тесты может написать чтоб ниче не забыть?
  ...
  static const Map<String, String> _rusToEng = {
    ...
    'Cкрыть автоматический расчет спиртуозности' : 'Hide the automatic calculation of alcohol content',
    ...
    'Не давать засыпать телефону' : 'Not to let the phone go to sleep', //TODO тут остановился
    ...
    'Спиртуозность' : 'Alcohol content',
    'в кубе:' : 'in the still:',
    'в отборе:' : 'in the body collectIon:',
